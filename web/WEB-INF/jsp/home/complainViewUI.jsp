...
<div class="vp_d_1">
    ...
    <div class="vp_d_1_1">
        <div class="content_info">
            ...
            <div class="tableH2">投诉详细信息<span style="color:red;">(<s:property value="#stateMap[comp.state]"/>)</span>
            </div>
            <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <s:property
                                value="%{comp.compMobile.substring(0,3) + '****' + comp.compMobile.substring(7,11)}"/>
                    </s:elseif>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">
                        <s:iterator value="comp.complainReplys" status="st">
                            <fieldset style="border: solid 1px #c0c0c0;margin-top:5px;">
                                <legend style="color:green;font-weight:bold;">回复<s:property value="#st.count"/>&nbsp;
                                </legend>
