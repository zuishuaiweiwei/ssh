        ...
        <td width="331" align="right" valign="top">
            <table width="350" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="left"></td>
                    <td align="right">
                        <a><b></b><font color="red">欢迎您，<s:property value="#session.user.name"/>&nbsp;</font></a>
                    </td>
                    ...
                    <td align="left" valign="middle"><a href="${ctx }/sys/login_outLogin.action">退出</a></td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <td width="76" height="100" align="center" valign="middle">
                        <div class="left-tx">
                            <s:if test="%{#session.USER.headImg != null && #session.user.headImg !=''}">
                                <img src="${ctx}/upload/<s:property value='#session.user.headImg'/>" width="70"
                                     height="70"/>
                            </s:if><s:else>
                        ...
                        <table width="95%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td colspan="2" style=" font-weight:bold; color:#3a7daa;"><s:property
                                        value="#session.user.name"/></td>
                            </tr>
                            <tr>
                                <td colspan="2">所属部门：<s:property value="#session.user.dept"/></td>
                            </tr>
                        </table>
                    </td>
                </tr>
        ...
        <div class="left_grzx1">
            ...
            <table width="98%" border="0" align="center">
                <s:iterator value="infoList">
                    <tr>
                        <td height="23">
                            <s:url var="infoViewUrl" action="home_infoView" namespace="/sys">
                                <s:param name="info.id"><s:property value="id"></s:property> </s:param>
                            </s:url>
                            <s:a href="%{infoViewUrl}">
                                <s:property value="title"></s:property>
                            </s:a>
                        </td>
                        <td width="150px">
                            <s:property value="#typeMap[type]"></s:property>
                        </td>
                        <td width="150px">
        ...
        <div class="lc_grzx1">
            ...
            <table width="98%" border="0" align="center">
                <s:iterator value="complainList">
                    <tr>
                        <td height="23">
                            <s:url var="complainViewUrl" action="home_complainView" namespace="/sys">
                                <s:param name="comp.compId">
                                    <s:property value="compId"></s:property>
                                </s:param>
                            </s:url>
                            <s:a href="%{complainViewUrl}">
                                <s:property value="compTitle"></s:property>
                            </s:a>
                        </td>
                        <td width="180px">
                            <s:property value="#stateMap[state]"></s:property>
                        </td>
                        <td width="180px">
                            <s:property value="isNm?'匿名投诉':'非匿名投诉'"></s:property>
                        </td>
                        <td width="180px">
