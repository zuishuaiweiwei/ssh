...
<form id="form" name="form" action="${basePath }nsfw/role_update.action" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
            <div class="content_info">
                <div class="c_crumbs">
                    <div><b></b><strong>角色管理</strong>&nbsp;-&nbsp;编辑角色</div>
                </div>
                ...
                <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0"
                    ...
                    <tr>
                        ...
                        <td>
                            <s:checkboxlist list="#privilegeMap" name="privilegeId"></s:checkboxlist>
                        </td>
                    </tr>
                    <tr>
