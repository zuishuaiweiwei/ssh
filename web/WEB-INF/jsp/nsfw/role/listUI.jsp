...
<head>
    ...
    <script type="text/javascript">
        ...
        //编辑
        function doEdit(id) {
            document.forms[0].action = "${basePath}nsfw/role_updateUi.action?role.roleId=" + id;
            document.forms[0].submit();
        }
        //删除
        ...
        function doDeleteAll() {
            document.forms[0].action = "${basePath}nsfw/role_deleteAll.action";
            document.forms[0].submit();
        }
