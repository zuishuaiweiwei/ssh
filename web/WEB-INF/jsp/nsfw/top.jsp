...
<table width="1222" border="0" align="center" cellpadding="0" cellspacing="0"
       background="${basePath}images/nsfw/xingzheng.png" class="top">
    <tr>
        ...
        <td width="300" align="right" valign="top">
            <table width="350" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td width="17" align="center"><img src="${basePath}images/nsfw/exit.png" width="14" height="14"/>
                    </td>
                    <td align="left" valign="middle"><a href="${basePath}sys/login_outLog.action" target="_top">退出</a>
                    </td>
                </tr>
            </table>
        </td>
