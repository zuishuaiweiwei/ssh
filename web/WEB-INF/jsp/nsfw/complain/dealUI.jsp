        ...
        <div class="p_d_1_1">
            <div class="content_info">
                ...
                <div class="tableH2">投诉详细信息<span style="color:red;">(<s:property
                        value="#stateMap[complain.state]"/>)</span></div>
                <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <s:property
                                    value="%{complain.compMobile.substring(0,3) + '****' + complain.compMobile.substring(7,11)}"/>
                        </s:elseif>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <s:iterator value="complain.complainReplys" status="st">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <s:hidden name="complainReply.replyDept" value="%{#session.user.dept}"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <s:hidden name="complainReply.replyName" value="%{#session.user.name}"/>
                        </td>
                    </tr>
                ...
                <s:hidden name="strTitle" value="%{strTitle}"/>
                <div class="tc mt20">
