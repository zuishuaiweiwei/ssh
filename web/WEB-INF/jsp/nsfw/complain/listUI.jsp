    ...
    <div class="p_d_1">
        <div class="p_d_1_1">
            <div class="content_info">
                <div class="c_crumbs">
                    <div><b></b><strong>投诉受理管理</strong></div>
                </div>
                <div class="search_art">
                    ...
                    <li>
                        状态：<s:select name="complain.state" list="#stateMap" headerKey="" headerValue="全部"/>
                    </li>
                    <li><input type="button" class="s_button" value="搜 索" onclick="doSearch()"/></li>
                    <li style="float:right;">
                        <input type="button" value="统计" class="s_button" onclick="doAnnualStatisticUi()"/>&nbsp;
                    </li>
                    ...
                    <table width="100%" border="0">
                        ...
                        <s:iterator value="pageResult.items" status="st">
                            <tr <s:if test="#st.odd"> bgcolor="f8f8f8" </s:if> >
                                ...
                                <td align="center"><s:property value="#stateMap[state]"/></td>
                                <td align="center">
                                    <s:if test="state !=2">
